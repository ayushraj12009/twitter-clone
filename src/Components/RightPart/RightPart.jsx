...
const RightPart = () => {
  ...
  return (
    <div className="py-5 sticky top-0">
      ...
      <section className=" my-5">
        ...
        <h1 className="fond-bold my-2">Subscribe to unlock new Features </h1>
        <Button
          variant="contained"
 ...
 >
      ...
      <section className="mt-7 space-y-5">
        <h1 className="font-bold text-xl py-1"> What's happinging</h1>
        <div>
          <p className="text-sm">World Cup Match</p>
