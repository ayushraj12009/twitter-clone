...
export default function SubscriptionModal({handleClose,open}) {
  ...
  const fetures=["Prioritized rankings in conversations and search", 
    ...
    "All the existing Blue feature, including Edit Tweet, Bookmark Folders and early access to new features."
]
  return (
    <div>
      <Modal
        ...
        <Box sx={style}>
          ...
          <div className="flex justify-center py-10">
            <div className="w-[80%] space-y-10">
              ...
              <div className="flex justify-between rounded-full px-5 py-3 border border-gray-600">
                <div>
                  ...
                  <span
                    ...
                    className={
                      '${plan==="Yearly"?"text-black":"text-gray-400" }cursor-pointer'
                    }
                  >
                    Yearly
                  </span>
                ...
                <p
                  onClick={() => setPlan("Yearly")}
                  className={
                    '${plan==="monthly"?"text-black":"text-gray-400" }cursor-pointer'
                  }
                >
                  Monthly
                </p>
              ...
              <div className="space-y-3">
                {fetures.map((item)=> <div className="flex items-center space-x-5">
              ...
              <div className="cursor-pointer flex justify-center bg-gray-900 text-white rounded-full px-5 py-3 ">
                ...
                <span className="px-5">₹6,000/year</span>
              </div>
